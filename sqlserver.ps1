...
Start-Process "C:\Windows\Temp\SQLFULL_x64_ENU\SETUP.exe" -ArgumentList "/Q", "/ACTION=install", "/IACCEPTSQLSERVERLICENSETERMS=1", "/FEATURES=SQL,MDS,Tools", "/SQLSYSADMINACCOUNTS=$hostname\$adminUser", "/INSTANCENAME=$hostname\mssqlserver" -Wait
